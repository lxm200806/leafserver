...
It has these top-level messages:
	...
	XC2G_LoginGate_Req
	XG2C_LoginGate_Ack
	XC2G_GetUserInfo_Req
	XG2C_GetUserInfo_Ack
	XC2G_StartMatch_Req
	XG2C_StartMatch_Ack
	XC2G_ReturnLobby_Ntt
	XC2G_CreateRoom_Req
	XG2C_CreateRoom_Ack
	XG2C_PlayerDisconnect_Ntt
	XActor_GamerReady_Ntt
	XActor_GamerGrabLandlordSelect_Ntt
	XActor_GamerPlayCard_Req
	XActor_GamerPlayCard_Ack
	XActor_GamerPlayCard_Ntt
	XActor_GamerPrompt_Req
	XActor_GamerPrompt_Ack
	XActor_GamerDontPlay_Ntt
	XActor_Trusteeship_Ntt
	XCGamerInfo
	XCGamerCards
	XActor_GamerEnterRoom_Ntt
	XActor_GamersInRoom_Ntt
	XActor_GamerExitRoom_Ntt
	XActor_GamerReconnect_Ntt
	XActor_GameStart_Ntt
	XActor_AuthorityGrabLandlord_Ntt
	XActor_AuthorityPlayCard_Ntt
	XActor_SetMultiples_Ntt
	XActor_SetLandlord_Ntt
	XActor_Gameover_Ntt
	XActor_GamerMoneyLess_Ntt
	Test
	UserLogin
	UserRegister
	UserResult
