var Toast = {
    ...
    makeText: function(text, duration, gravity, x, y) {
        return Toast._makeText(text, duration, gravity, x, y);
    },

    showText: function(text, duration, gravity, x, y) {
        Toast._showText(text, duration, gravity, x, y);
    },
};

Toast._makeText = function (text, duration, gravity, x, y) {
    let _text = text;
...
Toast._showText = function (text, duration, gravity, x, y) {
    Toast.makeText(text, duration, gravity, x, y).show();
}